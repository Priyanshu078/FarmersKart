...
class _SignInState extends State<SignIn> {
  ...
  Future<void> Login() async {
    ...
    if(password!=null&&phoneNo!=null)
      {
         List<UserOfApp> userAccountData= await fetchLoginApiData(phoneNo, password);
         if(userAccountData==null)
           authenticated=false;
         else
           {
             authenticated=true;
             Provider.of<APIData>(context,listen:false).initializeUser(userAccountData[0]);
          //   Provider.of<APIData>(context,listen:false).initialUserId(userAccountData[0].id);
              userId=userAccountData[0].id;
           }
